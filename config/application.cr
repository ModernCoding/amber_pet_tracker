...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Pet Tracker Amber web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 0S_bMZywZPsEUl9ru8hcNJ_jChBsHE49Bw-jBHPb-o0
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("pet_tracker_amber.log", "w"))
  #
  #
end
